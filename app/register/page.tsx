...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a1628] text-[#c8dde2] font-sans p-4 py-10">
      <div className="w-full max-w-md p-10 bg-[#0f1f35]/60 rounded-3xl border border-[#68bfcd]/15 backdrop-blur-md shadow-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2 font-serif">Create Account</h1>
          <p className="text-sm text-[#c8dde2]/60">Sign up to get started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div>
            <label className="block text-sm mb-2 text-[#c8dde2]/80">Full Name</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="block text-sm mb-2 text-[#c8dde2]/80">Confirm Password</label>
            <div className="relative">
              <input
        ...
        <div className="mt-6 flex flex-col gap-3">
          <button type="button" className="w-full p-3.5 bg-white/5 border border-white/10 rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-3 hover:bg-white/10 transition-colors">
          ...
          <button type="button" className="w-full p-3.5 bg-[#1877F2] rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-3 hover:bg-[#1877F2]/90 transition-colors">
        ...
        <p className="mt-8 text-center text-sm text-[#c8dde2]/60">
          ...
          <Link href="/login" className="text-[#68bfcd] font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
